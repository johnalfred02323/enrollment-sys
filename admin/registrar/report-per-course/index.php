...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Per Major</li>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card 5 start -->
  ...
  <div class="card-header py-3">
    ...
    <div class="card-body" >
      <table id="courselist" class="display nowrap" style="width:100%">
        <thead>
            <tr>
                <th>Course</th>
                <th>Major</th>
...
$(document).on( 'click','.print', function (e) {
  ...
  var sem = $('#sem').val();
  var newWin = window.open('print.php?data='+id+'&data2='+schoolyear+'&data3='+sem);
...
$(document).on( 'click','.excel', function (e) {
  ...
  $.ajax({
        url:"process.php",
        method:"POST",
        data:{"excelfilename":1,major:major,schoolyear:schoolyear,sem:sem},
        success:function(data){
          filename = data;
        }
      }); 
  ...
  $.ajax({
        url:"process.php",
        method:"POST",
        data:{"studentlistexcel":1,major:major,schoolyear:schoolyear,sem:sem},
        success:function(data){
...
$(document).on( 'click','.view', function (e) {
  ...
  $.ajax({
        url:"process.php",
        method:"POST",
        data:{"studentlist-view":1,major:major,schoolyear:schoolyear,sem:sem},
        success:function(data)
        {
