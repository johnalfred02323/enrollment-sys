...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../cashier-dashboard.php">Dashboard</a> / Petition</div>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <div class="card-body" >
      ...
      <table id="petition" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
...
dashpetition_data();
function dashpetition_data(){
  var table = $('#petition').DataTable( {
