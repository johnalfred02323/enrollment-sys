...
if(isset($_GET['id'])){
  ...
  $result = mysqli_query($conn, "SELECT class_record.id as cr_id, class_record.submitted, class_record.sched_id, class_record.excel_file, schedule.section FROM class_record INNER JOIN schedule ON class_record.sched_id = schedule.sched_id WHERE class_record.id = $cr_id") or trigger_error(header('Location: ../404'));
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <div style="float:right;">
        ...
        <button id="submit_grades" class="custom-ds"><i class="fas fa-send"></i> Submit</button>&nbsp;&nbsp;<a href="#" id="submission_help" style="display: none;" data-toggle="tooltip" title="Upload Class Record First"><i class="far fa-question-circle"></i></a>
      </div>
  </div>
    <div class="card-body">
    ...
    <tr id="cc<?= $ss ?>">
      ...
      <td>
        <div class="input-group">
          <input type="text" class="form-control w-100 prelim_remarks" name="<?= $row['student_number'] ?>" aria-label="Text input with dropdown button" id="prelim<?= $row['student_number'] ?>" disabled>
          <div class="input-group-append" style="display: none;" id="prelim<?= $row['student_number'] ?>">
            <button id="<?= $row['student_number'] ?>" class="btn btn-outline-secondary dropdown-toggle prelim_inc" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
      ...
      <td>
        <div class="input-group">
          ...
          <div class="input-group-append" style="display: none;" id="midterm<?= $row['student_number'] ?>">
            <button id="<?= $row['student_number'] ?>" class="btn btn-outline-secondary dropdown-toggle midterm_inc" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
            <ul class="dropdown-menu checkbox-menu allow-focus">
            <li>
                <label>Outstanding Balance
      ...
      <td>
        <div class="input-group">
          ...
          <div class="input-group-append" style="display: none;" id="final<?= $row['student_number'] ?>">
            <button id="<?= $row['student_number'] ?>" class="btn btn-outline-secondary dropdown-toggle final_inc" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
            <ul class="dropdown-menu checkbox-menu allow-focus">
            <li>
                <label>Outstanding Balance
