...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><a href="../">Dashboard</a> / Reports / Generate Tuition Fees</li>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <h6 class="m-0 font-weight-bold card-text-title-head">Reports</h6>
    ...
    <div class="card-body" >
      ...
      <table id="transfees" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
      ...
      <a href="print_tuitionfees.php?from_date=<?php echo $_POST['from_date']; ?>&to_date=<?php echo $_POST['to_date']; ?>" target="new" class="btn btn-flat add-user pull-xs-right"><i class="fa fa-print"></i> Print</a>
