...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../cashier-dashboard.php">Dashboard</a> / Statement of Account</div>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Statement of Account</h6>

  </div>

    <div class="card-body" >

      <table id="sao_table" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
...
<?php require 'statement-modal.php'; ?>
...
dashsao_data();
function dashsao_data(){
  var table = $('#sao_table').DataTable( {
...
$('#sao_table').on( 'click', 'button.edit', function (e) {
    var id = $(this).attr("id");
    $('#id_val').val(id);
    $.ajax({
      url:"statement-process.php",
      method:"POST",
...
$(document).on('click', '#print', function(){
  ...
  $.ajax({  
    ...
    window.open('statementaccount?studentnumber='+stud+'&schoolyear='+sy1+'&fullname='+name+'&unit='+unit1+'&course='+course);
