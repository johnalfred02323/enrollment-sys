...
if(isset($_POST['editfees'])){
  ...
  if(mysqli_num_rows($result) == 1){
    ...
    <div class="modal-header">
        ...
        <h5>Course: <span id="kurs"> <b>'.$row["course_abbreviation"].'</b> </span></h5>        
