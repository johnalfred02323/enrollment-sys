...
require('../../../src/fpdf/fpdf.php');
    ...
    $query = "SELECT admission_student_info.student_number, admission_student_info.st_lname, admission_student_info.st_fname, admission_student_info.st_mname, admission_student_info.st_suffix,
      admission_student_info.course, admission_student_info.major, student_enrollment_record.date, schedule.semester, schedule.school_year
      FROM student_enrollment_record 
      Inner join admission_student_info on admission_student_info.student_number = student_enrollment_record.student_number
      Inner join schedule on schedule.sched_id = student_enrollment_record.sched_id WHERE admission_student_info.student_number = '$studno'";
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(1);
    $pdf->Cell(50, 6, ''.$row['st_lname'].'', 1, 0);
    $pdf->SetFont('Arial', 'B', 8);
    $pdf->Cell(1);
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(1);
    $pdf->Cell(50, 6, ''.$row['st_fname'].'', 1, 0);
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(1);
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(1);
    $pdf->Cell(50, 6, ''.$row['st_mname'].'', 1, 0);
    $pdf->SetFont('Arial', 'B', 8);
    $pdf->Cell(1);
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(1);
    $pdf->Cell(50, 6, ''.$row['st_suffix'].'', 1, 0);
    $pdf->Cell(1);
    $pdf->SetFont('Arial', 'B', 8);
