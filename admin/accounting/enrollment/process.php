...
if(isset($_POST['fetch_single'])) {
 ...
 //      WHERE student_info.student_number = '".$sn."'"; 
      ...
      $query = "SELECT student_info.student_number, student_info.lastname, student_info.firstname, student_info.middlename, course.course_abbreviation as course, course.course_major as major FROM student_info INNER JOIN course ON student_info.course_id = course.course_id WHERE student_number ='".$sn."'";
        ...
        $stud_info = mysqli_fetch_assoc($result);
          $output .= '<div class="row">
                <div class="col-sm-4"> 
                      ...
                      Student Number: <span id="sn"><strong>'.$stud_info["student_number"].'</strong></span><br>
                      ...
                      Name: <strong>'.$stud_info["lastname"].',&nbsp;'.$stud_info["firstname"].'&nbsp;'.$stud_info["middlename"].'</strong>
                      
                      <br>
                      Course: <span id="course"><strong>'.$stud_info["course"].'</strong></span>&nbsp;&nbsp;&nbsp; <span id="major">Major: <strong>'.$stud_info["major"].'</strong></span>
                      
                      <div class="row">
                      <div class="col-sm-6">
                      <div class="box1">
                          <select name="yrlvl1" id="yrlvl2" required class="col-sm-10" title="Year Level">
                      ...
                      <div class="col-sm-6">
                      <div class="box1">
                          <select name="reg1" id="reg2" required class="col-sm-10" title="Status">
    ...
    $get_fees = mysqli_query($conn, "SELECT * FROM tuition_fees");
        $output .= '<div class="box1">
                      <select name="samp2" id="samp1" required class="col-sm-11" title="Tuition Fees Per Unit">
        ...
        $output .= '</div> 
            <div class="col-sm-4">
                      ...
                      <div class="box1">
                          <select name="scholar1" id="scholar" required title="Type of Scholar">
       ...
       {
        $output .= '<br/><div class="row"><div class="col-sm-4"><strong><label>Miscellaneous:</label> '.$row['sum(price)'].'</strong> 
        <br>
