...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><a href="../index">Dashboard</a> / Setting Fees / Other Fees</li>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Other Fees</h6>

      <button type="button" id="add_fees_btn" class="add-user pull-xs-right" data-toggle="modal" data-target="#otherfees_modal" ripple onclick="reset()"><i class="fas fa-plus"></i> ADD NEW</button>

  </div>

    <div class="card-body" >
      
      <table id="otfees" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
                      <th>Description</th>
                      <th>Price</th>
...
<?php require 'otherfees_modal.php'; ?> 
  ...
  <div class="modal-dialog modal-sm" style="max-width: 350px;">
    <div class="modal-content">
      <div class="modal-body">
        <h6>Are you sure to delete this Other Fees?</h6>
      </div>
...
$('#otfees').on( 'click', 'button.edit', function (e) {
    var id = $(this).attr("id");
    $('#id_val').val(id);
    $.ajax({
      ...
      success:function(data){
        $('#ofees_forms').html(data);
        $('#ofees_forms').show();
        $('#ofees_forms_new').hide();
      }
    });
});

$('#otfees').on( 'click', 'button.delete', function (e) {
    id = $(this).attr("id");
});
