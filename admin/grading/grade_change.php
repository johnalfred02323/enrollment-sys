...
<script src="../../src/vendor/jquery/jquery-3.3.1.min.js"></script>
  ...
  <title>GRC | Grading System | Grade Change</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Grade Change</li>
  </ol>
</nav>
  <!-- SPACER -->
...
<div class="card shadow-sm mb-4"> <!-- card start -->
 ...
 <!-- Card Header - Dropdown -->
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    <h6 class="m-0 font-weight-bold card-text-title-head">Grade Change</h6>
  </div>
    ...
    <div class="card-body" >
      ...
      <div class="box1" style="width: 13%;">
          ...
          <br>
      <table class="display no-wrap" id="class_table" style="width:100%">
        <thead>
            <tr>
                <th>Faculty Name</th>
                <th>Section</th>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#class_table').on('click', '.change-gr', function(e) {
        e.preventDefault();
        var cr_id = $(this).attr('id');
        var encodedID = window.btoa(cr_id);
        window.open('change_of_grades?id='+encodedID, '_self');
      });

      function fetch_class(sy) {
