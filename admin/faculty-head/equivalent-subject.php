<!-- Head -->
<?php require '../../src/layout/faculty-head/head.php'; ?>
<head>
<!-- jquery -->
...
<div class="card shadow-sm mb-4">
  <div class="card-header d-flex justify-content-end">
    <button type="button" class="add-user no pull-xs-right" data-toggle="modal" data-target="#modal"><i class="fas fa-plus"></i> Add</button>
  </div>
  <div class="card-body">
    ...
    <div class="table-responsive">      
      <table class="table table-bordered">
        <caption>
          ...
          <p><i class="fas fa-info-circle"></i> Input Subject Code</p> 
          <button type="button" class="edit-user edit" ripple><i class="fas fa-plus"></i> Add Row</button>
          </div>
        </caption>
        <thead>
          <tr>
        ...
        <tbody class="table-bordered">
          <tr>
            <th class="p-0"><input class="form-controls shadow-none m-0 border-0 rounded-0 bg-transparent" type="text"></th>
            <th class="p-0"><input class="form-controls shadow-none m-0 border-0 rounded-0 bg-transparent" type="text" placeholder="N/A" readonly></th>
            <th class="p-0"><input class="form-controls shadow-none m-0 border-0 rounded-0 bg-transparent" type="text"></th>
            <th class="p-0"><input class="form-controls shadow-none m-0 border-0 rounded-0 bg-transparent" type="text" placeholder="N/A" readonly></th>
            <th class="p-0"><input class="form-controls shadow-none m-0 border-0 rounded-0 bg-transparent" type="text" placeholder="N/A" readonly></th>
            <th class="p-0"><input class="form-controls shadow-none m-0 border-0 rounded-0 bg-transparent" type="text" placeholder="N/A" readonly></th>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="save" id="" ripple><i class="fas fa-check"></i> SAVE</button>
      </div>
    </div>
  </div>
</div>
