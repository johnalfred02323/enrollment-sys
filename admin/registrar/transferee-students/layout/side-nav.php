    ...
    <ul class="navbar-nav side-bar sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#studentlistsn" aria-expanded="true" aria-controls="studentlistsn">
          <i class="fas fa-users"></i>
          <span>Students</span>
        </a>
        <div id="studentlistsn" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="sub-nav py-2 collapse-inner">
            ...
            <a class="collapse-item" href="./"> Transferee</a>
          </div>
        </div>
      </li>
