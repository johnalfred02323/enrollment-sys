...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="../">Dashboard</a> / Setting of Fees / Other Tuition Related Fees</li>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Current Fees</h6>

      <button type="button" id="add_fees_btn" class="add-user pull-xs-right" data-toggle="modal" data-target="#ms_modal" ripple onclick="reset()"><i class="fas fa-plus"></i> ADD NEW</button>
    ...
    <div class="card-body" >
      ...
      <table id="misc" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
                      <th>Other Tuition Related Fees</th>
                      <th>Price</th>
...
$('#misc').on( 'click', 'button.delete', function (e) {
    id = $(this).attr("id");
});
