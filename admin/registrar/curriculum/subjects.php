...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="BSIT ">Curriculum</a></li>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold">Subjects (<?php echo $_GET['course']; ?>) | <?php echo $_GET['curriculumtitle']; ?></h6>

      <button type="button" id="" class="add-user pull-xs-right" data-toggle="modal" data-target="#suject_modal" ripple onclick="reset()"><i class="fas fa-plus"></i>ADD SUBJECTS</button>
