...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../cashier-dashboard.php">Dashboard</a> / Transaction / Followup Fees</div>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Followup Fees</h6>
  ...
  <br>
   ...
   <div id="transaction_div" class="row" style="display: none;"> <!-- ROW Start Here -->
       ...
       <input type="text" class="form-controls" id="change" aria-label="Default" placeholder="Change" aria-describedby="inputGroup-sizing-default" disabled=""><br>
        ...
        <div class="col-ms-3">
        <!-- Modal Add -->
        <button id="" class="view-user pull-xs-right edit" ripple data-toggle="modal" data-target="#scholar_modal" > <i class="fas fa-plus"> Add</i></button>
