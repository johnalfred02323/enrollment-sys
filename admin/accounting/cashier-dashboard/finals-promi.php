...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../cashier-dashboard.php">Dashboard</a> / Finals with Promissory</div>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Finals with Promissory</h6>

  </div>

    <div class="card-body" >

      <table id="fd-promi" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
...
dashfd_promi();
function dashfd_promi(){
  var table = $('#fd-promi').DataTable( {
