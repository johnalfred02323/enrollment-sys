<!-- Start of Top Nav -->
 ...
 <div class="column-icon">
                  ...
                  <div class="column-icon">
                    <a class="text-decoration-none text-gray-600" href="../accounting/"> 
                    <div class="card-icon">
                ...
                <div class="column-icon">
                  <a class="text-decoration-none text-gray-600" href="../../enlistment/">
                    <div class="card-icon">
                      <h5><i class="fas fa-clipboard-list icon"></i></h5>
                      <p>Enlistment</p>
                    </div>
                  </a>
                </div>
            ...
            <li class="nav-item dropdown"><!-- OR <li class="nav-item dropdown no-arrow"> -->
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="profile/?ID=<?php echo $_COOKIE['username'] ?>">
