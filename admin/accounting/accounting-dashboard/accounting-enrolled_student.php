...
$columns = array(
  ...
  array('db' => 'course_abbreviation', 'dt' => 2),
  array('db' => 'year_level', 'dt' => 3),
  array('db' => 'enrolled_date', 'dt' => 4, 'formatter' => function($d,$row){return date('jS M Y', strtotime($d));})
...
$WHERE = 'status = "Enrolled" AND schoolyr = "'.$result_data['school_year'].'" AND semester = "'.$result_data['semester'].'" ';
