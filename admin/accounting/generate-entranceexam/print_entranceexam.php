...
require('../../../src/fpdf/fpdf.php');
	...
	class PDF extends FPDF
	{
        function Header(){
            ...
            $this->Cell(8);
            $this->Cell(50,10, 'Entrance Exam', 0,0);
