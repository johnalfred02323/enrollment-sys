...
<div class="card shadow-sm mb-4"> <!-- card start -->
 ...
 <!-- Card Header - Dropdown -->
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    <h6 class="m-0 font-weight-bold card-text-title-head">Grade Viewing Code</h6>
  </div>

    <div class="card-body" >
      <div class="row py-3 d-flex flex-row align-items-center justify-content-between" style="width: 100%;">
        <div class="col">
      ...
      <table class="display no-wrap" id="student_table" style="width:100%">
        <thead>
          <tr>
            ...
            <th>Name</th>
            <th>Grade&nbsp;Viewing&nbsp;Code</th>
            <th class="align-items-center">Generate&nbsp;Code</th>
          </tr>
        </thead>
      </table>
    </div>
  ...
  <script type="text/javascript">
      ...
      function get_data(get_all) {
        ...
        var table = $('#student_table').DataTable({
          ...
          "ajax" : {
                ...
                "data":{
                  "course":all,
                  "school_year":"<?php echo $check_sy_sem_data["school_year"];?>",
                  "semester":"<?php echo $check_sy_sem_data["semester"];?>" }
          },
          responsive: true,
    ...
    $('#student_table').on('click', '.generate', function(){
      var id = $(this).attr('id');
      $.ajax({
        url:"process.php",
        method:"POST",
        data:{"generate_code":1,id:id,sy:"<?php echo $check_sy_sem_data["school_year"];?>",sem:"<?php echo $check_sy_sem_data["semester"];?>"},
