<form id="ofees_form">
  ...
  <div id="d" class="form-group">
    <input id="description" spellcheck=false class="form-control" type="text" size="18" alt="login" required="" name="miscellaneous" autocomplete="off">
  ...
  <div id="p" class="form-group">
    <input id="price" spellcheck=false class="form-control" type="text" size="18" alt="login" required="" name="price" onkeyup="numbersonly(this)" autocomplete="off">
      <span class="form-highlight"></span>
        <span class="form-bar"></span>
    ...
    if(description == '' || price == ''){
      ...
      if(price == ''){
       ...
       $.ajax({
        ...
        method:'POST',
        data:{"addfees":1,description:description,price:price},
