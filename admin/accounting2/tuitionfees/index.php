...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><a href="../index">Dashboard</a> / Setting Fees / Tuition Fees</li>
  </ol>
</nav>
  ...
  <div class="modal-dialog modal-sm" style="max-width: 350px;">
    <div class="modal-content">
      <div class="modal-body">
        <h6>Are you sure to delete this Tuition Fees?</h6>
      </div>
