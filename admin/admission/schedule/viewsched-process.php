...
if(isset($_POST['firstyearsched']))
{
    ...
    where curriculum.course = '$course' AND subject.yrsem_id = '".$yrsem."' AND curriculum.major = '".$major."' AND schedule.section != 'Petition' AND schedule.school_year = '".$sy."' ORDER BY schedule.section ASC";
...
if(isset($_POST['petitionsched']))
{
  ...
  $cou = 0;
    ...
    INNER JOIN subject ON schedule.subj_id = subject.subj_id
    INNER JOIN curriculum ON subject.curriculum_title = curriculum.curriculum_title where schedule.section = 'Petition' AND schedule.semester = '$sem' AND schedule.school_year = '$sy'";
    $result = mysqli_query($conn, $query); 
