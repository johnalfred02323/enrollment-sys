...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../">Dashboard</a> / Transaction</div>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Transaction</h6>

  </div>

    <div class="card-body" >

      <table id="all-transaction" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
                      <th>Name</th>
...
dashtrans_data();
function dashtrans_data(){
  var table = $('#all-transaction').DataTable( {
      ...
      "ajax" : "accounting-transaction.php",
