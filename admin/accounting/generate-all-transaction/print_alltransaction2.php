...
<h5><b><br>All Transaction</b> <p class="pull-right">From: <b><?php echo $from_date ?></b> To: <b><?php echo $to_date ?></b></p></h5>
</div>
...
<div class="col-xs-12 table-responsive">
          <table class="table table-hover table-striped" id="all_trans">
              ...
              <thead> 
                ...
                <tbody>  
                  <?php
                    $query= "SELECT * FROM transaction_all where date_paid between '$from_date' and '$to_date' ORDER BY `transaction_all`.`official_receipt` ASC " ;
