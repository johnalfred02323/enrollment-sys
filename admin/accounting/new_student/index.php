...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../cashier-dashboard">Dashboard</a> / Transaction / New Student</div>
  </ol>
</nav>
...
<div class="mx-auto" style="height: 20px;"></div>
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    <h6 class="m-0 font-weight-bold card-text-title-head">Student Enrollment</h6>
  </div>
...
$(document).on('click', '#generate', function(){  
           ...
           var fullname = $('#fl').text();            // Full Name
           var snum1 = $('#sisnum1').text();            // Sisnum
