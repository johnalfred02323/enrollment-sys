...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <div class="breadcrumb-item active" aria-current="page"><a href="../cashier-dashboard.php">Dashboard</a> / Midterm with Promissory</div>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 font-weight-bold card-text-title-head">Midterm with Promissory</h6>

  </div>

    <div class="card-body" >

      <table id="md-promi" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
...
dashmd_promi();
function dashmd_promi(){
  var table = $('#md-promi').DataTable( {
