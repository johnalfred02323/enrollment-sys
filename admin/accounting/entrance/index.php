...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><a href="../">Dashboard</a> / Setting Fees / Entrance Exam</li>
  </ol>
</nav>
...
<div class="card shadow-sm mb-4"> <!-- card start -->
  ...
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <button type="button" id="add_fees_btn" class="add-user pull-xs-right" data-toggle="modal" data-target="#entrance_modal" ripple onclick="reset()"><i class="fas fa-plus"></i> ADD NEW</button>

  </div>

    <div class="card-body" >

      <table id="entrance" class="display nowrap" style="width:100%">
              <thead>
                  <tr>
                      <th>Description</th>
                      <th>Price</th>
...
$('#entrance').on( 'click', 'button.edit', function (e) {
    var id = $(this).attr("id");
    $('#id_val').val(id);
    $.ajax({
...
$('#entrance').on( 'click', 'button.delete', function (e) {
    id = $(this).attr("id");
});
